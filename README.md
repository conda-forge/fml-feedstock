...
Once the `conda-forge` channel has been enabled, `fml` can be installed with:

```
conda install fml
```

It is possible to list all of the versions of `fml` available on your platform with:
